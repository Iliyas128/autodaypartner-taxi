...
export const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary via-primary/90 to-primary/70">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left space-y-8 animate-slide-up">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-primary-foreground leading-tight">
              AutoDayPartner
              <span className="block text-3xl md:text-4xl lg:text-5xl font-bold mt-2 opacity-90">
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              <div>
                <div className="text-4xl font-black text-primary-foreground">24/7</div>
                <div className="text-sm text-primary-foreground/80 font-medium">Поддержка</div>
              </div>
              <div>
                <div className="text-4xl font-black text-primary-foreground">0%</div>
                <div className="text-sm text-primary-foreground/80 font-medium">Комиссий</div>
              </div>
              <div>
                <div className="text-4xl font-black text-primary-foreground">1 день</div>
